...
/**
 * Created by Antreas Christofi on 02/03/2015.
 */
...
public class OfflinePvPClient {
    ...
    public static void initialGame(){
        ...
        while ((player1.getNumbersFromRoll1() == player2.getNumbersFromRoll2())){//||(player2.getNumbersFromRoll1() == 0)) {//While they are the same...
...
//First two ifs are to choose vector depending on color of currentplayer
    ...
    public static void sendRollToServer(){
        ...
        try{
            ...
            BufferedOutputStream bos = new BufferedOutputStream(connection.getOutputStream());//create output stream for msg
            OutputStreamWriter osw = new OutputStreamWriter(bos, "US-ASCII");//create write for output msg
    ...
    public static void main(String args[]) {
        ...
        System.out.print("What is your name?");//It then asks for the first name.
        name1 = input.nextLine();//One of you types it in.
        player2.setName(name1);//He remembers that one of his attributes as a player is a name, and now he has one.
